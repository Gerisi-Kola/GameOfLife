...
class WindowGameOfLife():
    ...
    def toggle_cell_screen(self, x, y):
        ...
        rect = plt.Rectangle((x, y), 1, 1, fill=True, facecolor=color, edgecolor=self.edgecolor)
    ...
    def init(self):
        #grid.fill(0)  # Réinitialise la grille en blanc
        #grid[pos_y, pos_x] = 1  # Place le carré à sa position initiale
        
        self.ax.set_array(self.actual_stage)
        return [self.ax]
