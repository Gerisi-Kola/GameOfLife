...
- ***24-04*** : Le desin des boutons est meilleur (utilisation de ttk). J'ai corrigé le bug des murs sur l'algo !!! J'ai crée un fichier 'menu_game_of_life.py' qui ajoute un manu 'File' et 'Help' qui peut ouvrir une 2e fenêtre
